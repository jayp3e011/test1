...
<head>
  ...
  <script src="<?php echo realpath(__DIR__."/../app/controllers/app.js") ?>"></script>
    ...
    <?php echo $_SERVER['PHP_SELF'];?> self<br>
      ...
      <?php
        ...
        if(isset($_GET['page'])){
          ...
          require_once(realpath(__DIR__.$page_url));
        }
        else{
...
<!--     <footer class="main-footer">
  ...
  <script src="<?php echo realpath(__DIR__."/../app/controllers/script.js") ?>"></script>
